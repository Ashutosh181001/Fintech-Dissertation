...
DATABASE_PATH = "/data/output/trading_anomalies.db"  # absolute path for container
TRADE_LOG = "/data/output/trades.csv"  # absolute path for container
ANOMALY_LOG = "/data/output/anomalies.csv"  # absolute path for container
